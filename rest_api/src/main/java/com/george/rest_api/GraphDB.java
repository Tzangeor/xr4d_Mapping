...
public class GraphDB {
	...
	public final static String serverName="RestAPI";
    public final static String serverURL="http://192.168.1.2:7200";
	
//	public static void add(String name) throws RepositoryException, RDFParseException, IOException {
//		
//		
